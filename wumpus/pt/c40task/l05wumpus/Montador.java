        ...
        if(caverna != null && instrucoes != null){
            ...
            for(int i = 0; i < instrucoes.length; i++){
                ...
                if(caracterCriacao != '_') {
                    ...
                    /*if (caracterCriacao != 'P') {
                        if (caracterCriacao == 'B') 
                        	caracterSecundario = 'b';
                        else 
                        	caracterSecundario = 'f';
                        if(caverna.salaExiste(l - 1, c)) 
                        	caverna.addComponente(l, c, caracterSecundario);
                        if(caverna.salaExiste(l + 1, c)) 
                        	caverna.addComponente(l, c, caracterSecundario);
